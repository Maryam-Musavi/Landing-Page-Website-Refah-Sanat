...
export const Logo: React.FC<LogoProps> = ({ className = 'w-10 h-10', size }) => {
  ...
  return (
    ...
    >
      ...
      {/* Left Arrow (Pointing LEFT) - Metallic Steel Gray */}
      <polygon
        points="8,100 44,62 44,78 22,100 44,122 44,138"
        fill="#6C788A"
      />

      {/* Right Arrow (Pointing RIGHT) - Metallic Steel Gray */}
      <polygon
      ...
      <g transform="translate(100, 85)" fill="none" stroke="#ffffff" strokeWidth="2.5">
        ...
        <circle cx="0" cy="0" r="10" fill="#003B70" stroke="#ffffff" strokeWidth="2" />
      ...
      <g transform="translate(100, 128)">
        ...
        <polygon points="-38,-4 -8,8 -8,18 -38,6" fill="#002D56" stroke="#ffffff" strokeWidth="1.5" />
        <polygon points="-8,8 22,-4 22,6 -8,18" fill="#001F3D" stroke="#ffffff" strokeWidth="1.5" />
        <polygon points="-38,-4 -8,8 22,-4 -8,-16" fill="#ffffff" />
        {/* Document line details */}
        <line x1="-22" y1="-5" x2="-8" y2="2" stroke="#003B70" strokeWidth="1.5" />
        <line x1="-8" y1="2" x2="6" y2="-5" stroke="#003B70" strokeWidth="1.5" />

        {/* Stack 2 (Right Sheet Stack) */}
        <polygon points="-22,10 8,22 8,30 -22,18" fill="#002D56" stroke="#ffffff" strokeWidth="1.5" />
        <polygon points="8,22 38,10 38,18 8,30" fill="#001F3D" stroke="#ffffff" strokeWidth="1.5" />
        <polygon points="-22,10 8,22 38,10 8,-2" fill="#ffffff" />
        {/* Document line details */}
        <line x1="-8" y1="9" x2="8" y2="16" stroke="#003B70" strokeWidth="1.5" />
        <line x1="8" y1="16" x2="22" y2="9" stroke="#003B70" strokeWidth="1.5" />
      </g>
    </svg>
  );
};

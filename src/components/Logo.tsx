...
export const Logo: React.FC<LogoProps> = ({ className = 'w-10 h-10', size }) => {
  ...
  return (
    ...
    >
      ...
      {/* Top Arrow (Pointing UP) - Deep Turquoise / Cyan Blue */}
      <polygon
        points="100,10 135,45 120,45 100,25 80,45 65,45"
        fill="#0891b2"
      />

      {/* Bottom Arrow (Pointing DOWN) - Deep Turquoise / Cyan Blue */}
      <polygon
        points="100,190 135,155 120,155 100,175 80,155 65,155"
        fill="#0891b2"
      />

      {/* Left Arrow (Pointing LEFT) - Metallic Silver / Gray */}
      <polygon
        points="10,100 45,65 45,80 25,100 45,120 45,135"
        fill="#94a3b8"
      />

      {/* Right Arrow (Pointing RIGHT) - Metallic Silver / Gray */}
      <polygon
        points="190,100 155,65 155,80 175,100 155,120 155,135"
        fill="#94a3b8"
      />

      {/* Central Square Container - Dark Navy / Deep Blue background */}
      <rect
        x="48"
        y="48"
        width="104"
      ...
      <g transform="translate(100, 85)" fill="none" stroke="#ffffff" strokeWidth="2.5">
        ...
        <circle cx="0" cy="0" r="10" fill="#084b83" stroke="#ffffff" strokeWidth="2" />
      ...
      <g transform="translate(100, 128)">
        ...
        <polygon points="-38,-4 -8,8 -8,18 -38,6" fill="#0e7490" stroke="#ffffff" strokeWidth="1.5" />
        <polygon points="-8,8 22,-4 22,6 -8,18" fill="#155e75" stroke="#ffffff" strokeWidth="1.5" />
        <polygon points="-38,-4 -8,8 22,-4 -8,-16" fill="#ffffff" />
        {/* Document line details */}
        <line x1="-22" y1="-5" x2="-8" y2="2" stroke="#084b83" strokeWidth="1.5" />
        <line x1="-8" y1="2" x2="6" y2="-5" stroke="#084b83" strokeWidth="1.5" />

        {/* Stack 2 (Right Sheet Stack) */}
        <polygon points="-22,10 8,22 8,30 -22,18" fill="#0e7490" stroke="#ffffff" strokeWidth="1.5" />
        <polygon points="8,22 38,10 38,18 8,30" fill="#155e75" stroke="#ffffff" strokeWidth="1.5" />
        <polygon points="-22,10 8,22 38,10 8,-2" fill="#ffffff" />
        {/* Document line details */}
        <line x1="-8" y1="9" x2="8" y2="16" stroke="#084b83" strokeWidth="1.5" />
        <line x1="8" y1="16" x2="22" y2="9" stroke="#084b83" strokeWidth="1.5" />
      </g>
    </svg>
  );
};

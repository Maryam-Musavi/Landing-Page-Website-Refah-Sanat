...
export const HeroSection: React.FC<HeroSectionProps> = ({ currentLang }) => {
  ...
  return (
    <section id="home" className="relative pt-28 pb-10 flex flex-col justify-between bg-slate-950 text-white border-b border-slate-800">
      
      {/* Background Grid Pattern - Matte Flat Industrial */}
      <div className="absolute inset-0 bg-grid-pattern opacity-20 pointer-events-none" />

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 my-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch mb-8">
          ...
          <div className="lg:col-span-7 z-10 flex flex-col justify-between">
            ...
            <div>
              {/* Category / Pill Badge - Sharp Industrial Box */}
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-900 text-cyan-400 text-xs font-mono font-semibold tracking-wider uppercase mb-5 border border-slate-700">
              ...
              <div className="text-slate-300 text-sm font-mono font-semibold uppercase tracking-widest mb-6 flex items-center gap-2">
                <span className="w-2 h-2 bg-cyan-400"></span>
                <span>{t.tagline}</span>
              </div>

              {/* Official Introduction Paragraphs */}
              <div className="space-y-3 text-slate-300 text-xs sm:text-sm leading-relaxed max-w-2xl mb-8 border-l-2 border-slate-700 rtl:border-r-2 rtl:border-l-0 pl-4 rtl:pr-4">
                <p>{t.introParagraph1}</p>
                <p className="text-slate-400 text-xs">{t.introParagraph2}</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              <button
                ...
                id="hero-primary-cta"
                className="bg-cyan-500 hover:bg-cyan-400 text-slate-950 px-7 py-3 font-bold text-xs uppercase tracking-wider transition-all inline-flex items-center justify-center gap-2 group cursor-pointer border border-cyan-400"
              >
              ...
              <button
                ...
                className="bg-slate-900 hover:bg-slate-800 text-slate-200 px-7 py-3 font-semibold text-xs uppercase tracking-wider border border-slate-700 transition-all inline-flex items-center justify-center cursor-pointer"
              >
          ...
          <div className="lg:col-span-5 relative">
            <div className="bg-slate-900 border border-slate-700 p-6 shadow-xl h-full flex flex-col justify-between">
              ...
              <div className="p-3 bg-slate-950 border border-slate-800 flex items-center justify-between text-xs">
                ...
                <span className="text-cyan-400 text-[10px] font-mono font-bold uppercase tracking-wider">
                  STATUS: ACTIVE
                </span>
              </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-800 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          <div className="p-3 bg-slate-900 border border-slate-800">
            ...
            <div className="text-[10px] text-slate-500 font-mono mt-0.5">Physical & Fin. Trade</div>
          </div>
          ...
          <div className="p-3 bg-slate-900 border border-slate-800">
            ...
            <div className="text-lg font-mono font-bold text-cyan-400">6 Regions</div>
            <div className="text-[10px] text-slate-500 font-mono mt-0.5">ME, CA, SA, EA, AF, EU</div>
          </div>
          ...
          <div className="p-3 bg-slate-900 border border-slate-800">
            ...
            <div className="text-[10px] text-slate-500 font-mono mt-0.5">USD, EUR, AED, CNY</div>
          </div>
          ...
          <div className="p-3 bg-slate-900 border border-slate-800">
            ...
            <div className="text-[10px] text-slate-500 font-mono mt-0.5">ISO 28000 Security</div>
          </div>
          ...
          <div className="p-3 bg-slate-900 border border-slate-800">
            ...
            <div className="text-[10px] text-slate-500 font-mono mt-0.5">Verified Legal Entity</div>
          </div>
          ...
          <div className="p-3 bg-slate-900 border border-slate-800">
            ...
            <div className="text-[10px] text-slate-500 font-mono mt-0.5">14+ Yrs Operating</div>
          </div>
        </div>
      ...
      <div className="w-full bg-slate-950 border-t border-slate-800 py-2.5 overflow-hidden text-white">
        <div className="max-w-7xl mx-auto px-4 flex items-center gap-4 text-xs font-mono text-slate-400 whitespace-nowrap overflow-x-auto no-scrollbar">
          <span className="flex items-center gap-1.5 font-bold text-cyan-400 uppercase tracking-wider shrink-0 text-[11px]">
            <Globe className="w-3.5 h-3.5 text-cyan-400" />
            {currentLang === 'fa' ? 'ارکان عملیاتی RSP:' : 'RSP OPERATIONAL PILLARS:'}
          </span>
          {t.intersectionTags.map((tag, idx) => (
            <span key={idx} className="flex items-center gap-2 shrink-0 bg-slate-900 px-2.5 py-0.5 border border-slate-800 text-slate-300 font-mono text-[11px]">
